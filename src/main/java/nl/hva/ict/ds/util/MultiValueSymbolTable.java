...
/**
 * This special symbol table is capable of storing multiple values under the
 * same key. When retrieving from this symbol table a list of values is
 * returned.
 *
...
public interface MultiValueSymbolTable<K, V> {
    ...
    /**
     * Adds a value to the list for the given key. If the value is null the list
     * will be emptied.
     *
